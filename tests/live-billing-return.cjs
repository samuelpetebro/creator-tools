...
assert(js.includes("billingLiveManageButton:'Cancel subscription'"),'live return must expose PayPal cancellation management');
assert(js.includes("attempt<7"),'live return must retry while waiting for the webhook');
