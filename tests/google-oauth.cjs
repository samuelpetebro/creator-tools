...
assert(cfg.includes('googleOAuthEnabled:false'),'Google OAuth must remain feature-flagged off until provider credentials are configured');
...
console.log('google oauth scaffold checks: ok');
