...
- **Preset UI:** preset-capable tool pages load the shared saved-preset widget, so signed-in users can save/load/delete reusable settings directly beside the tool.
