...
en:{
  title:'Terms',
  updated:'Effective: September 19, 2026.',
  scope:'Using Droop',
  ...
  billingText:'When paid checkout is enabled, Lemon Squeezy acts as the merchant of record for Droop Pro purchases. Lemon Squeezy processes payment details, taxes, receipts, refunds and chargebacks. Droop does not receive or store your full card number.',
  cancel:'Cancellation',
  cancelText:'You can cancel future renewals through the available customer billing portal. After cancellation, Pro access normally continues until the end of the period you already paid for, unless a refund, chargeback or applicable law requires a different result.',
  refunds:'Refunds',
  refundsText:'Refund requests are reviewed case by case and may be processed through Lemon Squeezy. Lemon Squeezy may also issue refunds under its own payment and chargeback procedures. Nothing in these terms limits consumer rights that cannot legally be waived.',
  ...
  questions:'Questions',
  questionsText:'For account or billing questions, use the support or customer-management options shown inside Droop or in your Lemon Squeezy purchase receipt when paid subscriptions are live.',
  footer:'Private browser-based tools.',
  privacyFooter:'Privacy'
},
es:{
  title:'Términos',
  updated:'Vigentes desde: 19 de septiembre de 2026.',
  scope:'Uso de Droop',
  ...
  billingText:'Cuando el checkout pago esté habilitado, Lemon Squeezy actúa como merchant of record para las compras de Droop Pro. Lemon Squeezy procesa los datos de pago, impuestos, recibos, reembolsos y contracargos. Droop no recibe ni guarda el número completo de tu tarjeta.',
  cancel:'Cancelación',
  cancelText:'Podés cancelar futuras renovaciones desde el portal de facturación disponible. Después de cancelar, el acceso Pro normalmente continúa hasta el final del período que ya pagaste, salvo que un reembolso, contracargo o la ley aplicable requiera otro resultado.',
  refunds:'Reembolsos',
  refundsText:'Las solicitudes de reembolso se revisan caso por caso y pueden procesarse mediante Lemon Squeezy. Lemon Squeezy también puede emitir reembolsos según sus propios procedimientos de pago y contracargos. Nada de estos términos limita derechos del consumidor que legalmente no puedan renunciarse.',
  ...
  questions:'Preguntas',
  questionsText:'Para consultas de cuenta o facturación, usá las opciones de soporte o administración del cliente que aparezcan dentro de Droop o en tu recibo de Lemon Squeezy cuando las suscripciones pagas estén activas.',
