...
en:{
  ...
  billing:'Pro billing',
  billingText:'When paid Droop Pro checkout is enabled, Lemon Squeezy acts as the merchant of record and processes payment details, taxes, receipts, refunds and chargebacks. Droop stores subscription identifiers and status needed to grant Pro access, but does not receive or store your full card number.',
...
es:{
  ...
  billingText:'Cuando el checkout pago de Droop Pro esté habilitado, Lemon Squeezy actúa como merchant of record y procesa datos de pago, impuestos, recibos, reembolsos y contracargos. Droop guarda identificadores y estado de suscripción necesarios para habilitar Pro, pero no recibe ni guarda el número completo de tu tarjeta.',
